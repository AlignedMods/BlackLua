...
namespace Aria::Internal {
    ...
    public:
        ...
        inline char At(size_t index) {
            ARIA_ASSERT(index < m_Size, "StringView::At() out of bounds!");
            return m_Str[index];
        }
...
template <>
struct fmt::formatter<Aria::Internal::StringView> : formatter<string_view> {

    inline auto format(const Aria::Internal::StringView& view, format_context& ctx) const -> format_context::iterator {
